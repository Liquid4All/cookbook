...
- [Continuous pre-training](continuous-pre-training.ipynb)
- [Supervised Fine-Tuning](supervised-fine-tuning.ipynb)
- [Direct Preference Optimization](direct-preference-optimization.ipynb)
- [GRPO with verifiable rewards](grpo-with-verifiable-rewards.ipynb)
...
| Group Relative Policy Optimization (GRPO) with LoRA | LFM2.5-1.2B-Base<br>LFM2.5-1.2B-Instruct<br>LFM2.5-1.2B-Thinking<br>LFM2-2.6B-Exp<br>LFM2-2.6B<br>LFM2-8B-A1B<br>LFM2-700M<br>LFM2-350M | [With Unsloth](https://colab.research.google.com/drive/1mIikXFaGvcW4vXOZXLbVTxfBRw_XsXa5?usp=sharing) |