...
| Scrivano | Fine-tuned LFM2.5-350M for Italian document key-info extraction, with a fully local desktop app to use it | [Code](https://github.com/andreagemelli/scrivano) |
