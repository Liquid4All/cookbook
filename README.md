...
| Discord Moderator | Use LFM2.5-1.2b to check messages that exceed a predetermined character limit for suspicious content. | [Code](./examples/discord-moderator/README.md)
