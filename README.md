...
| Agent Swarm at the Edge | Automates C4 diagram and Architecture Decision Record (ADR) generation for solo developers and small teams, running fully on-device with no cloud dependency | [Code](https://github.com/steelwolf180/edge-agent-swarm) |
